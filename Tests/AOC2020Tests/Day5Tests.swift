...
final class Day5Tests: XCTestCase {
    ...
    func test1Part1() {
        ...
        XCTAssertEqual(pass1.seatId, 567)

        let pass2 = BoardingPass(data: "FFFBBBFRRR")
        XCTAssertEqual(pass2.row, 14)
        XCTAssertEqual(pass2.column, 7)
        XCTAssertEqual(pass2.seatId, 119)

        let pass3 = BoardingPass(data: "BBFFBBFRLL")
        XCTAssertEqual(pass3.row, 102)
	...
	func testResultPart1() {
        let result = Self.valuesPart1
            ...
            .map(\.seatId)
            .max()
        XCTAssertEqual(result, 938)
	}

    func testResultPart2() {
        let seatIds = Self.valuesPart1
            .split(separator: "\n")
            .map { $0.trimmingCharacters(in: .whitespacesAndNewlines) }
            .map(BoardingPass.init)
            .map(\.seatId)
        ...
        XCTAssertNotEqual(foundId, 71)
        XCTAssertEqual(foundId, 696)
    }
}
