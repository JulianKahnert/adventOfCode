...
struct Day1Tests {
    ...
    func testPart1() {
        let result = day1Part1(Self.testInputPart1)
        #expect(result == 11)
    }

    @Test("Day 1 Part 1")
    func testResultPart1() {
        let result = day1Part1(Self.inputPart1)

        print("Solution of part 1: \(result)")
        #expect(result == 2580760)
    }

    @Test("Day 1 Part 2 Example")
    func testPart2() {
        let result = day1Part2(Self.testInputPart2)
        #expect(result == 31)
    }

    @Test("Day 1 Part 2")
    func testResultPart2() {
        let result = day1Part2(Self.inputPart1)

        print("Solution of part 2: \(result)")
        #expect(result == 25358365)
    }
